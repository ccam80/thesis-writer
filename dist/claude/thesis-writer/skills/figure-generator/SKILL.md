...
This skill is intended to run with the `image-output` output style, which ships with this plugin. If your system prompt does not contain the line `IO-CANARY-8e05`, append this to your response to the author:

> This skill is intended to be used with the image-output output style. It is included in the plugin.
