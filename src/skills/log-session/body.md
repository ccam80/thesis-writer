...
- **Ungrounded-phase checkpoints (structure, paragraph, or sentence phases)**: These carry no per-type provenance tables. Aggregate their point counts qualitatively and compute provenance metrics from grounded-scope checkpoints only.
