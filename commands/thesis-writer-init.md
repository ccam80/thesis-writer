...
2. Ensure the deep-zotero MCP server is enabled in Claude settings
...
## Step 5: Verify deep-zotero MCP

Remind the user:
- The deep-zotero MCP server must be enabled for research features
